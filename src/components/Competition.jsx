      ...
      <div className='common-bg d-flex align-items-center justify-content-center h-screen overflow-hidden custom-py-md'>
          <div className='container'>
              <div className='row'>
                  ...
                  <div className="col-12 mx-auto col-lg-6 table-bg d-flex border-radius-xl align-items-center justify-content-center sm-py-xl overflow-hidden">
                      <div className="d-flex align-items-center justify-content-center w-100">
                         
                          <div className="table-responsive max-lg-w-full">
