          ...
          <div className="custom-container">
              <div className="d-flex flex-column flex-xl-row gap-3">
                  <div className="product-parent">
                      ...
                      <p className="m-0 text-white custom-text">
                      ...
                      <p className="m-0 mt-2 text-white custom-text">
                  ...
                  <div className="d-flex grid-container justify-content-center align-items-center w-100 h-100">
                      <div className="d-grid grid-box h-100">
                          <div className="grid-item-1 d-flex">
                              <img className="grid-image-small" src='/assets/images/png/connect-to-self-img.png' alt="products-img" />
                              <img className="grid-image-large" src='/assets/images/png/connect-to-bank-img.png' alt="products-img" />
                          </div>
                          <div className="grid-item-2 d-flex">
                              <img className="grid-image-small" src='/assets/images/png/key-texs-img.png'  alt="GridThree" />
                              <img className="grid-image-large" src='/assets/images/png/get-insights-img.png' alt="GridFour" />
                          </div>
                          <div className="grid-item-3 d-flex">
                              <img className="grid-image-large" src='/assets/images/png/add-multiple-img.png' alt="GridOne" />
                              <img className="grid-image-small" src='/assets/images/png/track-your-return-img.png' alt="GridTwo" />
                          </div>
                          <div className="grid-item-4 d-flex">
                              <img className="grid-image-large" src='/assets/images/png/multiple-bank-img.png' alt="GridThree" />
                              <img className="grid-image-small" src='/assets/images/png/filling-hmrc-img.png' alt="GridFour" />
                          </div>
                          <div className="grid-item-5 d-flex">
                              <img className="grid-image-small" src='/assets/images/png/book-keeping-img.png' alt="GridOne" />
                              <img className="grid-image-large" src='/assets/images/png/invoicing-img.png' alt="GridTwo" />
                          </div>
                          <div className="grid-item-6 d-flex">
                              <img className="grid-image-small" src='/assets/images/png/real-time-tax-img.png' alt="GridThree" />
                              <img className="grid-image-large" src='/assets/images/png/dedicated-tax-img.png' alt="GridFour" />
                          </div>
                      </div>
                  </div>
              </div>
